...
from .views import ListaLibros, LibroNuevo, UpdateView, DeleteView, DetallesClass, RealizarPrestamo, RealizarDevolucion, MisLibros, ListaGenero
from . import views
...
urlpatterns = [
    ...
    path('genero_list/', ListaGenero.as_view(), name='genero_list'),
]
